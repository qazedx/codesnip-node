angular.module('ContactsApp')
        .controller('YoutubeController', function ($scope, $rootScope, Contact, $location, options) {
            $rootScope.PAGE = "youtube";
        ...
        .controller('test1', function ($scope, $rootScope, $location, Contact, $routeParams) {
            $rootScope.PAGE = "test1";
            $scope.contact = Contact.get({id: parseInt($routeParams.id, 10)});
            $scope.delete = function () {
                $scope.contact.$delete();
                $location.url('/test1');
